...
export class ReactTemplate {
  ...
  public async render(data: any): Promise<string> {
    ...
    return `<!doctype html>${html}<script src="/react.min.js"></script><script src="/react-dom.min.js"></script><script>var exports={};var components={};${uglify.minify(code, { fromString: true }).code};ReactDOM.render(React.createElement(exports.default,{content:components.${data.contentId}}),document);</script></body></html>`;
  }
}
