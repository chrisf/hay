var container = document.querySelector('.intro__background');
...
var left = hsla();
var leftTop = new ParticleNetwork(c).map((iAmBlind));
var leftTits = new ParticleNetwork(c);

var right = hsla();
var rightTop = new ParticleNetwork(c);
var rightTits = new ParticleNetwork(c);
